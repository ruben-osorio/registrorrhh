...
echo "?id_func=".$id_func."&id_per=".$id_per;?>" target="_blank" onClick="window.open(this.href, 8, 'width=1000,height=700,scrollbars=yes,scrollbars=yes'); return false;"><img src="data/images/menu/7_1.png"/></a></td>

</tr>
<tr>
    
<td><a href="ModificaRegdatLabP.php<?
echo "?id_func=".$id_func."&id_per=".$id_per;?>" target="_blank" onClick="window.open(this.href, 7, 'width=1200,height=1000,scrollbars=yes'); return false;"><img src="data/images/menu/9.png"/></a></td>
