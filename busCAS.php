...
<body>
<fieldset>
<legend>Busqueda Funcionario - Registro CAS</legend>
...
if ($sw==1)
{
 ...
 while ($r=$db->fetch_array($rs))
 {
	...
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RegCAS.php?id='.$r[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=420\')" title="Registrar CAS"><img src="data/images/casadd.png"></a>	
	</td>	
  </tr>';
 }
 echo'
