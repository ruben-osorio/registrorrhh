<?php
//Include Common Files @1-E0083519
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "regdat_fcper.php");
...
//Class_Initialize Event @2-CD35BAEE
    function clsRecordfin_con($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->id_per = new clsControl(ccsTextBox, "id_per", $CCSLocales->GetText("Text1"), ccsInteger, "", CCGetRequestParam("id_per", $Method, NULL), $this);
            ...
            $this->source_fin->Values = array(array("TGN", "TGN"), array("CANASTA", "CANASTA"), array("UNICEF", "UNICEF"), array("ASDI", "ASDI"), array("TGN 252", "TGN 252"), array("DINAMARCA", "DINAMARCA"));
        }
    }
//End Class_Initialize Event

//Initialize Method @2-BFFB90AD
    function Initialize()
    {
...
//DataSource Variables @2-72918E23
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-97275B16
...
//Open Method @2-8EB235FE
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT *, id_fin_per \n\n" .
        "FROM fin_per {SQL_Where} {SQL_OrderBy}";
...
//Insert Method @2-153B5188
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("fin_per", $this->InsertFields, $this);
...
//Update Method @2-550CF8C8
    function Update()
    {
        ...
        $this->SQL = CCBuildUpdate("fin_per", $this->UpdateFields, $this);
...
//Class_Initialize Event @10-A27A98F4
...
//CheckErrors Method @10-07EE0D0D
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->id_per->Errors->Count());
...
//DataSource Variables @10-DB79B572
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @10-6643CEC7
...
//Prepare Method @10-AF0C8BC4
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlid_per", ccsInteger, "", "", $this->Parameters["urlid_per"], xxxxxx, false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "id_per", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
...
//Open Method @10-97FC4995
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT *, id_cat_per \n\n" .
        "FROM cat_per {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Insert Method @10-93CE2CC0
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("cat_per", $this->InsertFields, $this);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteInsert", $this->Parent);
        if($this->Errors->Count() == 0 && $this->CmdExecution) {
            $this->query($this->SQL);
            $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteInsert", $this->Parent);
...
//Update Method @10-C2BBA155
    function Update()
    {
        ...
        $this->SQL = CCBuildUpdate("cat_per", $this->UpdateFields, $this);
        $this->SQL .= strlen($this->Where) ? " WHERE " . $this->Where : $this->Where;
        if (!strlen($this->Where) && $this->Errors->Count() == 0) 
            $this->Errors->addError($CCSLocales->GetText("CCS_CustomOperationError_MissingParameters"));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteUpdate", $this->Parent);
...
//Class_Initialize Event @37-8ECD33F1
...
//CheckErrors Method @37-BA17E43D
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->id_per->Errors->Count());
...
//DataSource Variables @37-E3067BC6
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @37-7546D055
...
//Open Method @37-6840E899
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT *, id_eval_per \n\n" .
        "FROM eval_per {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Insert Method @37-AABB43C6
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("eval_per", $this->InsertFields, $this);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteInsert", $this->Parent);
        if($this->Errors->Count() == 0 && $this->CmdExecution) {
            $this->query($this->SQL);
            $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteInsert", $this->Parent);
...
//Update Method @37-3CAE4A68
    function Update()
    {
        ...
        $this->SQL = CCBuildUpdate("eval_per", $this->UpdateFields, $this);
        $this->SQL .= strlen($this->Where) ? " WHERE " . $this->Where : $this->Where;
        if (!strlen($this->Where) && $this->Errors->Count() == 0) 
            $this->Errors->addError($CCSLocales->GetText("CCS_CustomOperationError_MissingParameters"));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteUpdate", $this->Parent);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "regdat_fcperr.html";
$BlockToParse = "main";
