...
<p class="f_req">Recuerde que es una DECLARACIÓN JURADA y para que le sea  mas facil y seguro el completar el formulario, debe tener a mano toda la información requerida a llenar en el formulario de la Ficha Personal.</p>
</ul>
<p>
	    </div>
						</div>
		...
		<div class="login_box">
            ...
            <form name="login" id="login_form" action="" method="post">
				...
				<div class="alert alert-info alert-login">
					Si olvidó sus datos comuníquese con el interno 215
				</div>
				<div class="cnt_b">
					<div class="formRow">
					...
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="password" id="password" name="password" placeholder="Password/Contraseña" value="" />
						</div>
					</div>
