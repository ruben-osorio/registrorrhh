...
if (isset($_POST[to_excel]))
{
	...
	$excel=new ExcelWriter("NominaUNICEF.xls");
	if($excel==false) {   
			echo $excel->error;
	}
	//								
	...
	$excel->close();
	$msg= 'Los datos se han grabado con &eacute;xito. Descargue el fichero de <a href="NominaUNICEF.xls">Aqui</a>';	
	$sw=1;
...
$rs=$db->query("select l_name1, l_name2, name, date_ent, charge  
				...
				order by l_name1 asc, l_name2 asc");
echo '<fieldset>
	<legend>Nómina Funcionarios UNICEF</legend>
