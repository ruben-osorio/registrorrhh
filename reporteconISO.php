...
<tr> 		
        ...
        <td>MODALIDAD INGRESO: (Si es puesto de Carrera)</td>
...
<table width="990" border="0" align="center">
  <tr>
    <td align="center" bgcolor="#F5F4F3"><h2><br />
    ...
    <td width="986">
 	  <table width="995" border="0">
 	    <tr>
 	      <td width="989" bgcolor="#CCCCCC">
          	<h3>&nbsp;</h3>
 	  <h3>DATOS ACADÉMICOS - EDUCACIÓN
 	    </h3>
 	  <h3>BACHILLERATO (Especifique el último curso vencido ej. tercero medio): </h3>
     
 <table id="ftab" width="980" border="0" align="center" cellpadding="2" cellspacing="0">   
    <tr>
...
<br />
<!--datos academicos-->
 <table width="980" height="42" border="0" align="center" cellpadding="2" cellspacing="0">
      <td width="970">
 	    <h3>
...
<table width="990" border="0">
  <tr>
    <td bgcolor="#E6E2DF"><h3>FORMACIÓN</h3>
      
<!--idiomas-->
<table width="990" border="0" align="center" cellpadding="2" cellspacing="0">
  <td width="582"><h3>IDIOMAS:</h3></td>
<td width="400"><h3>OTROS CONOCIMIENTOS:</h3></td>
</table>
<table id="ftab" width="990" border="0" align="center" cellpadding="2" cellspacing="0">
 <tr>
...
<table width="980" border="0" align="center" cellpadding="2" cellspacing="0">
  <td width="582"><h3>DOCENCIA UNIVERSITARIA:
  </h3></td>
</table>
<table id="ftab" width="983" border="0" align="center" cellpadding="2" cellspacing="0">
 <tr>
 	<td width="204">UNIVERSIDAD:</td>	
 	<td width="197">ASIGNATURA:</td>	
 	<td width="140">CARRERA:</td>
   	<td width="204">DESDE FECHA:</td>
 	<td width="216">HASTA FECHA:</td>
 </tr>
<!--1-->
<tr>
	<td id="ftd">
...
<br />
<table width="980" border="0" align="center" cellpadding="2" cellspacing="0">
  <td width="582"><h3>EXPERIENCIA</h3>
      <h3>EXPERIENCIA LABORAL ANTERIOR FUERA DEL MINISTERIO:</h3>
    <span>*Indicar la trayectoria laboral de trabajos anteriores comenzando por el más reciente)<br />
