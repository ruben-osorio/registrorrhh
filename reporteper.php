...
//-------------REVISAR SI COMPLETO TODOS SUS DATOS----------------------
	...
	//Inicio para CAS
        $dbc = new Database(DB_SERVERC, DB_USERC, DB_PASSC, DB_DATABASEC);
        $dbc->connect();
...
//------------IDIOMAS------------------		
	...
	$rs11=$dbc->query("
	SELECT * FROM old_cas WHERE id_per ='$id_per' ORDER BY year_rat DESC , month_rat DESC LIMIT 1 
...
<table width="990" height="42" border="0" align="center" cellpadding="2" cellspacing="0">
	<tr>     
      <td><div align="center"><img src="images/logo_mini.jpg" alt="" width="254" height="60" /></div></td>
      <td></td> 
      <td width="179"><div align="center"><strong>SISTEMA DE REGISTRO</strong><br />
        <strong>FORM. SAP. REG-01</strong>      </div></td>
     </tr> 
     	<tr>     
      <td><div align="center">Dirección de Talento Humano</div></td>
      <td></td>
      <td>&nbsp;</td>
     </tr> 
	<tr>     
      ...
      <td width="628"><h1 align="center">FICHA PERSONAL</h1>
        <h4><br/> 
      Este documento debe ser llenado por todos los servidores que ingresen al Gobierno Autonomo Municipal de El Alto. El servidor público con su firma acreditada la veracidad de la información registrada.</h4></td>
...
<!-- datos servicio militar -->
 ...
 <table width="990" height="42" border="0" align="center" cellpadding="2" cellspacing="0">
    <td width="986">
 	<h2>
	    DATOS ACADÉMICOS - EDUCACIÓN (BACHILLERATO):
		</h2>
    </td>
</table>   
 <table id="ftab" width="989" border="0" align="center" cellpadding="2" cellspacing="0">   
...
<td width="582"><h2>EXPERIENCIA LABORAL:</h2>
<span>
...
<table id="ftab" width="420" border="0" align="right" cellpadding="2" cellspacing="0">
    ...
    <table id="ftab" width="990" border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
            <td  width="30%" >DIRECCION GENERAL:</td>
            <td   width="30%" >UNIDAD:</td>
            <td  width="25%" >ÁREA:</td>
            <td   width="15%" >JEFE INMEDIATO SUPERIOR:</td>
        </tr>
        <tr>
            <td  id="ftd">
                <? echo $rex13[dir_g]?>
        ...
        <tr>
            ...
            <td id="ftd"><? echo $rex13[charge]?></td>
        ...
        <tr>
            <td colspan="4" id="ftd2">NIVEL DE PUESTO:</td>
        </tr>

        <tr>
            <td colspan="4" id="ftd"><? echo $rex15[level]?></td>
        </tr>
    </table>
...
<tr> 		
        <td id="ftd">
  			<? if ($rex14[source_fin] == "TGN") echo "10"; else if ($rex14[source_fin] == "TGN-11") echo "11"; else echo $rex14[source_fin] ?>
   		</td>
 </tr>
</table>
  ...
  <tr>
    <td  id="ftd">
      <ul>
        ...
        <li>      Mediante la presente Declaración Jurada, el Declarante autoriza a las Autoridades competentes del Gobierno Autonomo Municipal de El Alto a verificar la información
          proporcionada.</li>
...
<table border="1" cellspacing="0" cellpadding="0" align="center" id="ftab">
  ...
  <tr>
    <td colspan="2" valign="top"><p align="center"><strong>SELLO DE RECEPCIÓN DE REGISTRO</strong></p></td>
  </tr>
  <tr>
