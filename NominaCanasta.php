...
if (isset($_POST[to_excel]))
{
	...
	$excel=new ExcelWriter("NominaCANASTA.xls");
	if($excel==false) {   
			echo $excel->error;
	}
	//								
	...
	$rs=$db->query("select l_name1, l_name2, name, date_ent, charge  
				...
				and fin_con.source_fin='CANASTA'
				and status='1'
	...
	$excel->close();
	$msg= 'Los datos se han grabado con &eacute;xito. Descargue el fichero de <a href="NominaCANASTA.xls">Aqui</a>';	
	$sw=1;
...
$rs=$db->query("select l_name1, l_name2, name, date_ent, charge  
				...
				order by l_name1 asc, l_name2 asc");
echo '<fieldset>
	<legend>Nómina Funcionarios CANASTA</legend>
