...
$rs1=$db->query("SELECT id_con FROM ".TABLE30." WHERE id_func = '$id_func'");
...
<tr>
    <td colspan="6" ><strong>SERVIDOR CONSULTORES</strong></td>
</tr>
  <tr>
...
echo "?id_func=".$id_func;?>" target="_blank" onClick="window.open(this.href, 6, 'width=1200,height=1000,scrollbars=yes'); return false;"><img src="data/images/menu/6.png"/></a></td>
    <td><a href="ModificaRegdatLabC.php<?
echo "?id_func=".$id_func."&id_con=".$id_con;?>" target="_blank" onClick="window.open(this.href, 7, 'width=1200,height=1000,scrollbars=yes'); return false;"><img src="data/images/menu/7.png"/></a></td>
    <td><a href="ModificaFinCatCon.php<?
echo "?id_func=".$id_func."&id_con=".$id_con;?>" target="_blank" onClick="window.open(this.href, 8, 'width=1200,height=1000,scrollbars=yes,scrollbars=yes'); return false;"><img src="data/images/menu/8.png"/></a></td>
    <td><a href="ModificaRegMovCon.php<?
echo "?id_func=".$id_func."&id_con=".$id_con;?>" target="_blank" onClick="window.open(this.href, 9, 'width=1200,height=1000,scrollbars=yes,scrollbars=yes'); return false;"><img src="data/images/menu/9.png"/></a></td>
    <td><a href="reportecon.php<?
echo "?id_func=".$id_func."&id_con=".$id_con;?>" target="_blank" onClick="window.open(this.href, 10, 'width=1200,height=1000, scrollbars=yes'); return false;"><img src="data/images/menu/10.png"/></a></td>
  </tr>    
</table>
