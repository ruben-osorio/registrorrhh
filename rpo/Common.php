...
//Connection Settings @0-83390AB2
$CCConnectionSettings = array (
    "madnes" => array(
        ...
        "Host" => "100.0.100.105",
        "Port" => "3306;Database=registroRRHH",
        "User" => "rcanaviri",
        "Password" => "rcanaviri2012g0edu-",
        "Persistent" => false,
        "DateFormat" => array("dd", "/", "mm", "/", "yyyy"),
...
//Initialize Common Variables @0-1AEF6A0C
...
//madnes Connection Class @-BB72E24D
class clsDBmadnes extends DB_Adapter
{
    function clsDBmadnes()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["madnes"]);
        parent::Initialize();
