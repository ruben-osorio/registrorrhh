...
echo '	<td>
	<a href="#" onclick="MM_openBrWindow(\'RegBajac.php?id_func='.$r1[id_func].'&id_con='.$r1[id_con].'\',\'regpermiso\',\'scrollbars=yes,width=550,height=450\')" title="Baja Consultor"><img src="data/images/down.png"></a>
	</td>
  </tr>';
 }
