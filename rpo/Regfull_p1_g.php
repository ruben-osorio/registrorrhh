<?php
//Include Common Files @1-A6FA2F0D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "Regfull_p1_g.php");
...
//Class_Initialize Event @2-425A64F7
    function clsRecordfuncionario($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->nati = new clsControl(ccsTextBox, "nati", "Nati", ccsDate, array("ShortDate"), CCGetRequestParam("nati", $Method, NULL), $this);
            $this->ci = new clsControl(ccsLabel, "ci", "ci", ccsText, "", CCGetRequestParam("ci", $Method, NULL), $this);
            $this->date_born = new clsControl(ccsTextBox, "date_born", "date_born", ccsDate, array("ShortDate"), CCGetRequestParam("date_born", $Method, NULL), $this);
...
//DataSource Variables @2-8ED276CD
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F15AAB24
    function clsfuncionarioDataSource(& $Parent)
    {
        ...
        $this->nati = new clsField("nati", ccsDate, array("yyyy", "-", "mm", "-", "dd"));
        ...
        $this->UpdateFields["nati"] = array("Name" => "nati", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
...
//SetValues Method @2-E380FC3D
    function SetValues()
    {
        ...
        $this->nati->SetDBValue(trim($this->f("nati")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Regfull_p1_g.html";
$BlockToParse = "main";
