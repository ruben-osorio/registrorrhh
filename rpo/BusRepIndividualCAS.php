...
<body>
<fieldset>
<legend>Busqueda Funcionario - Reporte Individual CAS
</legend><form id="form1" name="form1" method="post" action="" class="form">
...
if ($sw==1)
{
 ...
 while ($r=$db->fetch_array($rs))
 {
	...
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RepIndivCAS.php?id='.$r[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=420\')" title="Reporte Individual"><img src="data/images/rep_cas.png"></a>	
	</td>	
  </tr>';
 }
 echo'
