...
<body>
<fieldset>
<legend>Busqueda Funcionario - Reporte Individual Saldo Vacaciones</legend>
...
if ($sw==1)
{
 ...
 while ($r=$db->fetch_array($rs))
 {
	...
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RepIndivSaldo.php?id='.$r[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=420\')" title="Reporte Individual"><img src="data/images/reporte.png"></a>	
	</td>	
  </tr>';
 }
 echo'
