...
<table width="912" height="326" border="0" align="center">
  <tr>
...
echo "?id_func=".$_SESSION['id_func'];?>" target="_blank" onclick="window.open(this.href, 6, 'width=1200,height=900,scrollbars=yes'); return false;"><img src="data/images/menu/6.png"/></a></td>
    <td><a href="regdat_lab-c.php<?
echo "?id_func=".$_SESSION['id_func']."&id_con=".$id_con;?>" target="_blank" onclick="window.open(this.href, 7, 'width=1200,height=900,scrollbars=yes'); return false;"><img src="data/images/menu/7.png"/></a></td>
    <td><a href="regdat_fccon.php<?
echo "?id_func=".$_SESSION['id_func']."&id_con=".$id_con;?>" target="_blank" onclick="window.open(this.href, 8, 'width=1200,height=900,scrollbars=yes'); return false;"><img src="data/images/menu/8.png"/></a></td>
    <td><a href="reg_mov_con.php<?
echo "?id_func=".$_SESSION['id_func']."&id_con=".$id_con;?>" target="_blank" onclick="window.open(this.href, 9, 'width=1200,height=900,scrollbars=yes'); return false;"><img src="data/images/menu/9.png"/></a></td>
    <td><a href="reportecon.php<?
echo "?id_func=".$_SESSION['id_func']."&id_con=".$id_con;?>" target="_blank" onclick="window.open(this.href, 10, 'width=1200,height=900,scrollbars=yes'); return false;"><img src="data/images/menu/10.png"/></a></td>
  </tr>
  <tr>
    <td colspan="6" ><strong>CONSULTOR DE LÍNEA</strong></td>
  </tr>
</table>
