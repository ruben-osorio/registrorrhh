...
<body>
<fieldset>
<legend>Busqueda Funcionario - Modificación de Saldo Dias de Vacación</legend>
...
if ($sw==1)
{
 ...
 while ($r=$db->fetch_array($rs))
 {
	...
	<td>
	<a href="#" onclick="MM_openBrWindow(\'UpdSaldoVac.php?id='.$r[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=420\')" title="Registrar CAS"><img src="data/images/update_.png"></a>		
	</td>	
  </tr>';
 }
 echo'
