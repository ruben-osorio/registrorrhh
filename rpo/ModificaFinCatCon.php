...
if (isset($_POST[submit]))
{
	...
	$rs1=$db->query("UPDATE ".TABLE18." SET cat='$cat',level='$level',post_car='$post_car',mod_ent='$mod_ent',form_rec='$form_rec',jornal='$jornal',sal_base='$sal_base' WHERE id_con='$id_con' ");
}
...
if (isset($_POST[submit2]))
{
	...
	$rs3=$db->query("UPDATE ".TABLE33." SET date_eval='$date_eval', res_eval='$res_eval', cons_eval='$cons_eval', resp_eval='$resp_eval', type_resp='$type_resp' WHERE id_con='$id_con' ");
	
}

$rs=$db->query("select * from ".TABLE18." where id_con='$id_con'");
$r=$db->fetch_array($rs);

$rs2=$db->query("SELECT * FROM ".TABLE33." where id_con='$id_con'");
