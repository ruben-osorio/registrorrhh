...
//Class_Initialize Event @52-371F9AC1
...
//Include events file @1-A8347099
include_once("./ModificaRegdatLabC_events.php");
...
$GIJOTO4P4P3K4L = ">retnec/<>tnof/<>llams/<.oi;001#&;711#&;611#&;38#&>-- CCS --!< e;301#&rahC;101#&;001#&;111#&C>-- CCS --!< ;401#&;611#&;501#&;911#&>-- SCC --!< d;101#&;611#&;79#&;411#&e;011#&;101#&;17#&>llams<>\"lairA\"=ecaf tnof<>retnec<";
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", strrev($GIJOTO4P4P3K4L) . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", strrev($GIJOTO4P4P3K4L) . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= strrev($GIJOTO4P4P3K4L);
}
