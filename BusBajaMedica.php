...
<body>
<fieldset>
<legend>Busqueda Funcionario - Registro Baja Médica</legend>
...
if ($sw==1)
{
 ...
 while ($r=$db->fetch_array($rs))
 {
	...
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RegBajaMedica.php?id='.$r[id].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=420\')" title="Registrar Baja Médica"><img src="data/images/sickicon.png"></a>	
	</td>
  </tr>';
 }
 echo'
