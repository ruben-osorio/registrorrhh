...
<body>
<fieldset>
<legend>Actualizar Saldos Días Vacación </legend>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  //$rs3=$db->query("select * from ".TABLE24." where id_per='$id_per'");
	$rs3=$db->query("select * from ".TABLE24." where id_per='$id_per' order by id_old_cas desc limit 1");
  ...
  <tr>
    ...
    <td><label for="textfield2"></label>
      <textarea name="observaciones" cols="30" rows="5" id="textfield2"><? echo $r4[observaciones]?></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
