...
<body>
<fieldset>
<legend>Busqueda Funcionario - Movilidad</legend>
...
echo '	
	<td>	
		<a href="#" onclick="MM_openBrWindow(\'RegMovilidad.php?id_func='.$r[id_func].'&id_per='.$r[id_per].'\',\'regpermiso\',\'scrollbars=yes,width=550,height=700\')" title="Registro de Movilidad"><img src="data/images/movilidad.png"></a>
	</td>	
...
echo '<td><a href="#" onclick="MM_openBrWindow(\'RegMovilidadc.php?id_func='.$r1[id_func].'&id_con='.$r1[id_con].'\',\'regpermiso\',\'scrollbars=yes,width=550,height=700\')" title="Registro de Movilidad"><img src="data/images/movilidad.png"></a></td></tr>';
 }
echo'
 </div></div>
</table>
