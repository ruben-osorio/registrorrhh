		...
		{		
			...
			if ($rs)
			{
				if (strcmp("TGN",$fuente) == 0)
				{
					...
					$rs1=$db->query("insert into ssrp.vacaciones (id_funcionario, gestion_1, dias_g1, gestion_2, dias_g2, observaciones)
					VALUES ('$id_func','$g1','0','','','')");
...
if ($sw==1)
{
	echo '<div class="successre">'.$msg.', imprima los <strong>datos de acceso del funcionario</strong> <a href="PrintDataFun.php?type='.$swf.'&id_func='.$id_func.'" target="_blank" onClick="window.open(this.href,this.target, \'width=550, height=400\'); return false;">  AQUI </a></div>';
	exit;
}
if ($sw==2)
{
...
<form id="form1" name="form1" method="post" action="" class="form">
  <table width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
      ...
      <td><div >
      <input class="textarea_normal required" name="expe" type="text"  id="expe" size="40" value="<? echo $rexe[expe]?>" />
       </div></td>
    </tr>
        <tr>
