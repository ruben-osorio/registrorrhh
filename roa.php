<?php
//Include Common Files @1-8D5AF13B
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "roa.php");
...
//Class_Initialize Event @2-1A65E0A6
    function clsRecordfuncionario($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->nationality = new clsControl(ccsTextBox, "nationality", "Nationality", ccsText, "", CCGetRequestParam("nationality", $Method, NULL), $this);
            ...
            $this->expe = new clsControl(ccsTextBox, "expe", "Expe", ccsText, "", CCGetRequestParam("expe", $Method, NULL), $this);
            ...
            $this->c_status = new clsControl(ccsTextBox, "c_status", "C Status", ccsText, "", CCGetRequestParam("c_status", $Method, NULL), $this);
            $this->sex = new clsControl(ccsTextBox, "sex", "Sex", ccsText, "", CCGetRequestParam("sex", $Method, NULL), $this);
            ...
            $this->type_lic = new clsControl(ccsTextBox, "type_lic", "Type Lic", ccsText, "", CCGetRequestParam("type_lic", $Method, NULL), $this);
            ...
            $this->title = new clsControl(ccsTextBox, "title", "Title", ccsInteger, "", CCGetRequestParam("title", $Method, NULL), $this);
        }
    }
...
//Validate Method @2-DDADDE1C
    function Validate()
    {
        ...
        $Validation = ($this->nationality->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->nationality->Errors->Count() == 0);
...
//CheckErrors Method @2-5B6FDCEE
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->nationality->Errors->Count());
...
//InsertRow Method @2-DFD25E57
    function InsertRow()
    {
        ...
        $this->DataSource->nationality->SetValue($this->nationality->GetValue(true));
...
//Show Method @2-2292336D
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->nationality->SetValue($this->DataSource->nationality->GetValue());
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->nationality->Errors->ToString());
...
//DataSource Variables @2-EE8788B2
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-93EE5847
    function clsfuncionarioDataSource(& $Parent)
    {
        ...
        $this->nationality = new clsField("nationality", ccsText, "");
        ...
        $this->InsertFields["nationality"] = array("Name" => "nationality", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["on_off"] = array("Name" => "on_off", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["nationality"] = array("Name" => "nationality", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//Prepare Method @2-F3290FC7
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlid_func", ccsInteger, "", "", $this->Parameters["urlid_func"], 637, false);
...
//Open Method @2-7B0C6601
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT *, id_func \n\n" .
...
//SetValues Method @2-A2D71A8B
    function SetValues()
    {
        ...
        $this->nationality->SetDBValue($this->f("nationality"));
...
//Insert Method @2-3898DAD9
    function Insert()
    {
        ...
        $this->InsertFields["nationality"]["Value"] = $this->nationality->GetDBValue(true);
        ...
        $this->InsertFields["on_off"]["Value"] = $this->on_off->GetDBValue(true);
...
//Update Method @2-C2AEFFEB
    function Update()
    {
        ...
        $this->UpdateFields["nationality"]["Value"] = $this->nationality->GetDBValue(true);
