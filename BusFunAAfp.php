...
<body>
<fieldset>
<legend>Busqueda Funcionario - Registro Datos AFP</legend>
 ...
 while ($r=$db->fetch_array($rs))
 {
    ...
    <td>'.$r[l_name2].'</td>
	 <td>'.$r[name].'</td>
	  ...
	  if ($r[afp]=='')
	  {
		 echo '<td><img src="data/images/Bad.png"> <strong>[NO REGISTRADO]</strong>'	;	
	  }
	  else
	  {
		 echo '<td><img src="data/images/Happy.png"> <strong>[REGISTRADO]</strong>'	;  
	  }
	  
		echo '	</td>
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RegDatosAFP.php?id='.$r[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=220\')" title="Registra AFP"><img src="data/images/afp.png"></a>
	</td>
  </tr>';
 }
    ...
    <td>'.$r1[l_name2].'</td>
	 <td>'.$r1[name].'</td>
	  ...
	  else
	  {
		...
		echo '	</td>
	<td>
	<a href="#" onclick="MM_openBrWindow(\'RegDatosAFP.php?id='.$r1[id_func].'\',\'regpermiso\',\'scrollbars=yes,width=600,height=220\')" title="Registra AFP"><img src="data/images/afp.png"></a>
	</td>
  </tr>';
 }
